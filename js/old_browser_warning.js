...
function e(str) {
    ...
    _dl.style.zIndex = "100";
    _dl.style.top = "0px";
    _dl.style.left = "0px";
    _dl.style.filter = "alpha(opacity=50)";
    _dl.style.opacity = "0.5";
    ...
    _uld.style.paddingLeft = "5px";
    _uld.style.styleFloat = "left";
    ...
    _ico4ds.background = "transparent url('" + imgPath + "browser_safari.gif') no-repeat scroll left top";
